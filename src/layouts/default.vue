    ...
    <div ref="dropdownMenu" class="menu-section">
      ...
      >
        <div v-if="isVisibleMenu" class="menu-expand">
          ...
          <div v-if="false" class="trans2menu-item" @click="openCreditos">
            <div class="icon">
              <BootstrapIcon icon="people" size="2x" class="trans4" />
            </div>
            <div class="label">Créditos</div>
          </div>
          <div v-if="false" class="menu-item" @click="openShare">
            <div class="icon">
              <BootstrapIcon
...
export default {
  ...
  computed: {
    background() {
      return this.$store.state.currentBackground || 'bg-mapa'
    },
    showInitialPage() {
